...
>
  ...
  <div class="p-4 mt-auto space-y-2">
    ...
    <a
      href="/"
      class="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-text dark:text-text-dark hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors"
    >
